                ...
                script{
                    ...
                    for (int a = 0; a < userDirectories.size(); a++){
                        ...
                        def jsonBody = """
                            ...
                            """
                        // validate html
                        def response = httpRequest acceptType: 'APPLICATION_JSON', contentType: 'APPLICATION_JSON', httpMode: 'POST', requestBody: jsonBody, responseHandle: 'NONE', url: '192.168.56.25:8080/api/validateHtmlForUsers', wrapAsMultipart: false
